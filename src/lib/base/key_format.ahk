...
class KeyFormat {
    ...
    static VirtualNewkeyFormat(value) {
        ...
        ; 将鼠标键位转为可读
        value := RegExReplace(value, "i)XBUTTON1", I18n.T("keyFormat.mouseBack"))
        value := RegExReplace(value, "i)XBUTTON2", I18n.T("keyFormat.mouseForward"))
        value := RegExReplace(value, "i)MButton", I18n.T("keyFormat.mouseMiddle"))
        value := RegExReplace(value, "i)RBUTTON", I18n.T("keyFormat.mouseRight"))
        value := RegExReplace(value, "i)WHEELDOWN", I18n.T("keyFormat.wheelDown"))
        value := RegExReplace(value, "i)WHEELUP", I18n.T("keyFormat.wheelUp"))
        value := RegExReplace(value, "i)WHEELLEFT", I18n.T("keyFormat.wheelLeft"))
        value := RegExReplace(value, "i)WHEELRIGHT", I18n.T("keyFormat.wheelRight"))
        value := RegExReplace(value, "i)ESCAPE", I18n.T("keyFormat.esc"))
        return value
    }
