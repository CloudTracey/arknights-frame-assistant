...
class ChangelogUI {
    ...
    static Show(version, body) {
        ...
        this.GuiObj := Gui("+AlwaysOnTop", I18n.T("changelog.title"))
        ...
        this.GuiObj.Add("Text", "y10 w450 Center", I18n.T("changelog.heading"))
        ...
        chkDontShowAgain := this.GuiObj.Add("Checkbox", "xs y+20", I18n.T("changelog.dontShowAgain"))

        btnConfirm := this.GuiObj.Add("Button", "x375 yp-12 w100 Default", I18n.T("msg.btnOk"))
