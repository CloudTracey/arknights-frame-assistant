...
class LevelDetector {
    ...
    static Objects := [
        ...
        {Name: "TextInLevel",
         Colors: [{C: 0xFFFFFF, V: 5}, {C: 0x9B9B9B, V: 5}],
         LX: 0.9275, RX: 0.9455, UY: 0.7833, DY: 0.8465},
        ; 退出按钮（左上角；灰色两色 + 其他模式深红/黄绿，OR；识别线加长至 65px 并左移到 x=136）
        {Name: "ExitButton",
         Colors: [{C: 0x868686, V: 10}, {C: 0x8C8C8C, V: 10}, {C: 0xB72518, V: 10}, {C: 0xBF2719, V: 10},
            {C: 0xD0CF67, V: 10}, {C: 0xD9D86B, V: 10}, {C: 0x555555, V: 10}, {C: 0x515151, V: 10},
            {C: 0x74180F, V: 10}, {C: 0x6F160F, V: 10}, {C: 0x848341, V: 10}, {C: 0x7E7E3F, V: 10}],
         LX: 0.0531, RX: 0.0535, UY: 0.0299, DY: 0.0750},
        ; 暂停按钮（右上角；白/浅灰两色 OR）
        {Name: "PauseButton",
         Colors: [{C: 0xFFFFFF, V: 5}, {C: 0xF5F5F5, V: 8}],
