...
class ReleaseRepository {
    ...
    static CheckGithub(localVersion) {
        ...
        if (localVersion = "") {
            ...
            return {status: "check_failed", localVersion: localVersion, remoteVersion: "", downloadUrl: "", message: I18n.T("无法获取本地版本号")}
        }
        ...
        try {
            ...
            if (req.error != "") {
                ...
                return {status: "check_failed", localVersion: localVersion, remoteVersion: "", downloadUrl: "", message: I18n.T("网络错误: {1}", req.error)}
            }
            ...
            Loop {
                ...
                if (A_TickCount - checkStart > this.TimeoutMs) {
                    ...
                    return {status: "check_failed", localVersion: localVersion, remoteVersion: "", downloadUrl: "", message: I18n.T("请求超时，请检查网络连接")}
                }
            }
            ...
            if (resp.statusCode = 401) {
                ...
                return {status: "token_invalid", localVersion: localVersion, remoteVersion: "", downloadUrl: "", message: I18n.T("GitHub Token无效，请检查设置")}
            }
            if (resp.statusCode = 403) {
                VersionChecker._Log("检测到API频率限制")
                return {status: "rate_limited", localVersion: localVersion, remoteVersion: "", downloadUrl: "", message: I18n.T("API请求频率超限。请在设置中配置GitHub Token以提高配额"), suggestToken: true}
            }
            if (resp.statusCode != 200) {
                VersionChecker._Log("服务器返回非200状态码: " resp.statusCode)
                return {status: "check_failed", localVersion: localVersion, remoteVersion: "", downloadUrl: "", message: I18n.T("服务器返回错误: {1} {2}", resp.statusCode, resp.statusText)}
            }
            ...
            if (isStable) {
                ...
                if (remoteVersion = "" || downloadUrl = "") {
                    ...
                    return {status: "check_failed", localVersion: localVersion, remoteVersion: "", downloadUrl: "", message: I18n.T("无法解析版本信息")}
                }
            ...
            if (errorInfo.code = "0x80072EE2")
                userMessage := I18n.T("网络请求超时，请检查网络连接后重试。`n`n如果问题持续存在，请尝试配置GitHub Token。")
    ...
    static _CheckDomesticChannel(localVersion, channelPath) {
        ...
        try {
            ...
            if (resp.statusCode != 200) {
                ...
                return {status: "check_failed", localVersion: localVersion, remoteVersion: "", downloadUrl: "", message: I18n.T("国内源返回错误: {1}", resp.statusCode)}
            }
            ...
            return {status: "check_failed", localVersion: localVersion, remoteVersion: "", downloadUrl: "", message: I18n.T("国内源检查失败: {1}", errorInfo.desc)}
        }
    }
